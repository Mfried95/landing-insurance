...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger); // resize last Width

var last_window_width = window.innerWidth; // animations
...
var scales = document.querySelectorAll('[data-scale]');
...
var carouselContainer = document.querySelector(['[data-carousel-container]']);
...
function initCarousel() {
  ...
  var active = document.querySelector('[data-carousel-container]').getAttribute('data-carousel-active') - 1;
  var swipeDistance = 0;
  var drag = false;
  placeItems(active);
  ...
  window.addEventListener('resize', function () {
    ...
    items.forEach(function (item, i) {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(item, {
        x: (i - active) * items[active].getBoundingClientRect().width / gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.getProperty(items[active], "scale"),
        force3D: true,
        minHeight: maxHeight
      });
    });
  ...
  function moveItems(current) {
    var itemWidth = items[active].getBoundingClientRect().width / gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.getProperty(items[active], "scale");
    items.forEach(function (item, i) {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(item, {
        force3D: true,
    ...
    items.forEach(function (item, i) {
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.matchMedia({
        ...
        "(max-width: 767.98px)": function maxWidth76798px() {
          gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(item, {
            scale: .95
          });
        }
  ...
  carouselContainer.addEventListener('touchstart', function (e) {
    ...
    var slideWidth = items[active].getBoundingClientRect().width / gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.getProperty(items[active], "scale");
    carouselContainer.addEventListener('touchmove', function (e) {
      return initTouchMove(e);
    });

    function initTouchMove(e) {
      var swipeX = e.touches[0].pageX;
  ...
  function initTouchEnd() {
    ...
    swipeDistance = 0;
    placeItems(active);
    carouselContainer.removeEventListener('touchmove', function (e) {
      return initTouchMove(e);
    });
    carouselContainer.removeEventListener('touchend', function () {
      return initTouchEnd();
    });
  }

  var initMouseMove, _initMouseEnd;
  ...
  carouselContainer.addEventListener('mousedown', function (e) {
    ...
    initMouseMove = function initMouseMove(e) {
      drag = true;
      var swipeX = e.pageX;
      swipeDistance = (startX - swipeX) / slideWidth / .8;
      moveItems(swipeDistance + active);
    ...
    _initMouseEnd = function initMouseEnd() {
      if (swipeDistance <= -.25) {
        active > 0 && active--;
      }
      ...
      document.removeEventListener('mouseup', _initMouseEnd, {
        once: true
      });
      document.removeEventListener('mouseleave', _initMouseEnd, {
        once: true
      });
    };

    document.addEventListener('mouseup', _initMouseEnd, {
      once: true
    });
    document.addEventListener('mouseleave', _initMouseEnd, {
      once: true
    });
  });
} // gallery
...
function initGallery() {
  ...
  var active = document.querySelector('[data-gallery-container]').getAttribute('data-gallery-active') - 1;
  var swipeDistance = 0;
  placeItems(active);
  var buttons = document.querySelectorAll('[data-gallery-button]');
  ...
  function placeItems(current) {
    ...
    var buttons = document.querySelectorAll('[data-gallery-button]');
    buttons.forEach(function (buttonGeneral) {
  ...
  function initTouchEnd() {
    ...
    placeItems(active);
    galleryContainer.removeEventListener('touchmove', function (e) {
      return initTouchMove(e);
    });
    galleryContainer.removeEventListener('touchend', function () {
      return initTouchEnd();
    });
  }
} // animation of trees
...
var trees = document.querySelectorAll('[data-name="tree"]');
trees.forEach(function (tree) {
  var wind = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    repeat: -1
  });
  wind.to(tree, {
...
var parallaxs = document.querySelectorAll('[data-parallax-container]');

if (parallaxs) {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(parallaxs, {
    scale: 1,
    opacity: 1,
    ease: "expo.out",
    duration: 2.4,
  ...
  parallaxs.forEach(function (parallax) {
    var layers = parallax.querySelectorAll('[data-parallax-layer]');
    layers.forEach(function (layer) {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(layer, {
        scrollTrigger: {
          start: "0px 0px",
          end: "".concat(window.innerHeight, "px 0px"),
          scrub: true
        },
...
var overlays = document.querySelectorAll('[data-hero-overlay]');
...
var clouds = document.querySelectorAll('[data-hero-clouds] > div');
clouds.forEach(function (cloud) {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('[data-hero-clouds]', {
    scale: 1,
    opacity: 1,
    ease: "expo.out",
    duration: 2.4,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(cloud, {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(cloud, {
    scale: 1,
...
var innerClouds = document.querySelectorAll('[data-inner-hero-clouds] > image');
innerClouds.forEach(function (cloud) {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('[data-inner-hero-clouds]', {
    scale: 1,
    opacity: 1,
    ease: "expo.out",
    duration: 2.4,
...
pipes.forEach(function (pipe) {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(pipe, {
    xPercent: getRandomArbitrary(-10, 10),
    opacity: .5,
    scale: getRandomArbitrary(1, 2.5),
    transformOrigin: "bottom center"
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(pipe, {
    scale: 0,
    opacity: 1,
...
var bike = document.querySelector('#bicycle');

if (bike) {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(bike, {
    x: 300,
    duration: 12,
    ease: "linear",
    repeat: -1,
...
if (dog) {
  var ear01 = document.querySelector('#Group_52');
  var ear02 = document.querySelector('#Group_53');
  var ears = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    repeat: -1,
    repeatDelay: 2,
    yoyo: true
  });
...
var objectTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
  repeat: -1
});
...
var objects = document.querySelectorAll("[data-hero-object]");
objects.forEach(function (object) {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(object, {
...
var clipPathOld = document.querySelector('[data-clip-old]');
var clipPathNew = document.querySelector('[data-clip]');
document.addEventListener('DOMContentLoaded', function () {
  if (clipPathOld) {
    initHero();
  }
...
function initHero() {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(clipPathOld.querySelector('circle'), {
    attr: {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(clipPathNew.querySelector('circle'), {
    scrollTrigger: {
      start: "64px 0px",
...
var closeBtn2 = document.getElementById("custom-modal-close2");

var actionBtn = document.getElementById("custom-modal-action");

var menuStatus = 'hidden';
var menuInnerStatus = 'hidden'; // navbar

var navbar = document.querySelector('[data-navbar]');
var navbar_logo = document.querySelector('#navbar-logo'); // overlay

var overlay = document.querySelector('#overlay'); // inner menu

var arrow = document.querySelector('[data-inner-menu-arrow]');
var innerMenu = document.querySelector('[data-inner-menu]');
var menu = document.querySelector('[data-menu]');
var button = document.querySelector('[data-inner-menu-button]'); // claim hero

var claimHero = document.querySelector('[data-claim-hero]'); // accordion

var accordions = document.querySelectorAll('[data-accordion-container]'); // parallax

var parallax = document.querySelector('[data-parallax]'); // init onload

document.addEventListener('DOMContentLoaded', function () {
  initNavbar();
  initInnerMenu();
  initMobileMenu();
  initFormModal(); // initFormClaims()
  ...
  const disclaimer = `The insurance products and information appearing and described on this website are for informational purposes only. Insurance products, policy provisions, coverages, restrictions, exclusions, terms, endorsements, and eligibility are subject to the policy wordings. Please contact your insurance broker for more information. All trademarks used on this website are owned by the respective owner. ©${year} Max Insurance. All rights reserved.`;
...
function showModal(show) {
  ...
  setTimeout(() => {
      // if only they're on the home page
      if (customModal) {
        disableScroll();
        ...
        actionBtn.onclick = () => {
          customModal.style.display = "none";
          enableScroll();
          window.open('https://max.maxinsurance.ca/claims/client-start-claim','_blank');
...
function initParallax() {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('[data-parallax-middle]', {
    scrollTrigger: {
      start: "top top",
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('[data-parallax-bottom]', {
    scrollTrigger: {
      start: "top top",
      end: "+=".concat(window.innerHeight),
      scrub: true
...
function initAccordions() {
  accordions.forEach(function (accordion) {
    ...
    var arrow = accordion.querySelector('[data-accordion-arrow]');
    title.addEventListener('click', function () {
      if (content.classList.contains('h-0')) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(accordion, {
...
function initClaimHero() {
  var tree = document.querySelector('[data-claim-hero-tree]');
  var finalScene = document.querySelector('[data-claim-hero-final]');
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.create({
    trigger: claimHero,
    start: "top bottom",
    onEnter: function onEnter() {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(tree, {
        rotate: -10
      }, {
        rotate: 0,
        duration: 2,
    ...
    onLeaveBack: function onLeaveBack() {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(tree, {
        rotate: -10,
        duration: 2,
        ease: "elastic.inOut(1, 0.999)"
      });
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(finalScene, {
...
function initFormModal() {
  ...
  var closeButton = document.querySelector('[data-close-form-button]');
  var initButtons = document.querySelectorAll('[data-init-form]');
...
function initFormClaims() {
  var modal = document.querySelector('[data-form-claims]');
  var closeButton = document.querySelector('[data-close-claims-button]');
  var initButtons = document.querySelectorAll('[data-init-claims]');
  initButtons.forEach(function (button) {
    button.addEventListener('click', function () {
      modal.classList.remove('pointer-events-none', 'opacity-0');
      disableScroll();
  ...
  function submitFormAjax() {
    ...
    xmlhttp.onreadystatechange = function () {
      if (this.readyState === 4 && this.status === 200) document.querySelector('#claimsform').innerHTML = this.responseText; // Here is the response
    };

    var title = modal.querySelector('input[name="formData"]').value;
    var name = modal.querySelector('input[name="name"]').value;
    var email = modal.querySelector('input[name="email"]').value;
    var phone = modal.querySelector('input[name="phone"]').value;
    var policynumber = modal.querySelector('input[name="policynumber"]').value;
    var message = modal.querySelector('textarea[name="message"]').value;
...
function showMenu() {
  var iconLine01 = document.querySelectorAll('[data-menu-button] div')[0];
  var iconLine02 = document.querySelectorAll('[data-menu-button] div')[1];
...
function initInnerMenu() {
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.matchMedia({
    "(min-width: 768px)": function minWidth768px() {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(innerMenu, {
        yPercent: 10,
        y: 0,
        opacity: 0,
        maxHeight: "auto"
...
function showInnerMenu() {
  ...
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.matchMedia({
    "(min-width: 768px)": function minWidth768px() {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(innerMenu, {
        yPercent: 10,
        y: 0,
        opacity: 0
      }, {
    ...
    "(max-width: 767.98px)": function maxWidth76798px() {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(innerMenu, {
        y: 0,
        overwrite: true,
...
function enableScroll() {
  var modal = document.querySelector('[data-form-modal]');
  var claimsModal = document.querySelector('[data-form-claims]');
  objectTimeline.play();
...
function initNavbar() {
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.matchMedia({
    "(min-width: 768px)": function minWidth768px() {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(navbar_logo, {
        y: "2.5rem",
        ...
        scale: .8,
        scrollTrigger: {
          start: "".concat(window.innerHeight / 2 + 24, "px 50%"),
          end: "+=24",
          scrub: .3,
    ...
    "(max-width: 767.98px)": function maxWidth76798px() {
      navbar.classList.remove('navbar-scrolled');
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(navbar_logo, {
        scale: .8,
        transformOrigin: "0% 50%",
        y: 0
      });
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(navbar_logo, {
        scrollTrigger: {
          start: "".concat(window.innerHeight / 2 + 10, "px 50%"),
          end: "+=10",
          onLeave: function onLeave() {
            navbar.classList.add('navbar-scrolled');
          },
...
if (document.querySelector('#jobs')) {
  var postJobs = async function postJobs() {
  ...
  var api = "https://boards-api.greenhouse.io/v1/boards/maxinsurance/departments";
  postJobs(api).then(function (data) {
    var departmentsList = data.departments;
    departmentsList.forEach(function (department) {
      var jobsList = department.jobs;

      if (jobsList.length !== 0) {
        var div = document.createElement('div');
        div.classList.add('mb-12', 'border-b-2', 'border-[#DDD]', 'overflow-hidden'); // if (jobsList.length > 1) {
        //     div.setAttribute('data-accordion-container', '')
        // }

        div.setAttribute('data-fade', '');
        var title = document.createElement('div');
        title.classList.add('mb-4', 'relative'); // title.setAttribute('data-accordion-title', '')
        ...
        title.append(h3); // if (jobsList.length > 1) {
        //     title.append(arrow)
        // }
        ...
        var contentInner = document.createElement('div'); // if (jobsList.length > 1) {
        ...
        jobsList.forEach(function (job, i) {
          if (i > 0) {
            var _link = document.createElement('a');

            _link.classList.add('font-medium', 'text-[16px]', 'md:text-[18px]', 'leading-[166%]', 'pr-16', 'sm:pr-0', 'sm:max-w-[25em]', 'underline', 'w-fit', 'text-max-blue', 'hover:no-underline');

            _link.innerText = job.title;
            _link.href = job.absolute_url;

            var _location = document.createElement('span');

            _location.classList.add('font-medium', 'text-[16px]', 'leading-[150%]', 'tracking-[-0.02em]', 'mb-[1em]');

            _location.innerText = job.location.name;
            contentInner.append(_link);
            contentInner.append(_location);
          }
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(div, {
          opacity: 1,
          y: 0,
          willChange: "transform",
          ease: "expo.out",
